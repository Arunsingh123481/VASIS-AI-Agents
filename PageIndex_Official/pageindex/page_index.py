...
def toc_transformer(toc_content, model=None):
    ...
    if if_complete == "yes" and finish_reason == "finished":
        ...
        toc_data = last_complete.get('table_of_contents', last_complete if isinstance(last_complete, list) else [])
    ...
    toc_data = last_complete.get('table_of_contents', last_complete if isinstance(last_complete, list) else []) if isinstance(last_complete, dict) else last_complete
    cleaned_response=convert_page_to_int(toc_data)
    return cleaned_response
