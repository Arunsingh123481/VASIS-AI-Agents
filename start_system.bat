...
cls
echo ============================================================
echo   PAGEINDEX-RE-MSE CRDB RAG SYSTEM - CONTROL PANEL
echo ============================================================
echo.
...
cls
echo ============================================================
echo   STARTING WEBPACK / FASTAPI SERVER
echo ============================================================
echo.
...
echo ============================================================
echo.
set /p pdf="Enter the absolute or relative path of the PDF: "
set "pdf=%pdf:"=%"
if not exist "%pdf%" (
    echo.
...
cls
echo ============================================================
echo   Exiting PageIndex-RE-MSE Control Panel.
echo ============================================================
echo.
timeout /t 2 >nul
exit
